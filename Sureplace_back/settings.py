...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        ...
        "agency_management": env("THROTTLE_AGENCY_MANAGEMENT", default="60/hour"),
        "agency_invitation": env("THROTTLE_AGENCY_INVITATION", default="20/hour"),
...
EMAIL_DELIVERY_MODE = env("EMAIL_DELIVERY_MODE", default="async").lower()
if EMAIL_DELIVERY_MODE not in {"async", "sync"}:
    raise RuntimeError("EMAIL_DELIVERY_MODE must be either 'async' or 'sync'.")
...
AGENCY_INVITATION_TTL_DAYS = env.int("AGENCY_INVITATION_TTL_DAYS", default=7)
...
PUBLIC_CONFIG_CACHE_SECONDS = env.int("PUBLIC_CONFIG_CACHE_SECONDS", default=900)
PUBLIC_REFERENCE_CACHE_SECONDS = env.int("PUBLIC_REFERENCE_CACHE_SECONDS", default=3600)
FEATURED_LISTINGS_CACHE_SECONDS = env.int("FEATURED_LISTINGS_CACHE_SECONDS", default=60)
CELERY_BROKER_URL = env("CELERY_BROKER_URL", default="redis://localhost:6379/0")
CELERY_RESULT_BACKEND = env("CELERY_RESULT_BACKEND", default=CELERY_BROKER_URL)
CELERY_TASK_ALWAYS_EAGER = env.bool("CELERY_TASK_ALWAYS_EAGER", default=False)
CELERY_BROKER_CONNECTION_TIMEOUT = env.int("CELERY_BROKER_CONNECTION_TIMEOUT", default=2)
