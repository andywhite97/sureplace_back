...
from .views import ReportCreateViewSet, ReportReviewViewSet, StaffPropertyModerationViewSet, listing_action, summary
...
router.register("staff/properties", StaffPropertyModerationViewSet, basename="staff-property-moderation")
